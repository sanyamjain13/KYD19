...
<body>
  <button class="btn btn-success btn-block" data-toggle='modal' data-target='#modal1' data-keyboard='false' data-backdrop='static'  onclick="startApp()">CLICK MEEEEEEEEEEEEEEE</button>
          ...
          <div class="col-md-6" style="border-left: 1px solid grey; ">
            ...
            <div class="tab-content">
              <div id="sign_in_menu" class="tab-pane fade in show active ">
                  <form method = "POST" action = "checkValidPatient.php">
                    <div class="form-group">
                      <input type="text" name="emailID" class="form-control" placeholder="Registered Mobile Number or Email ID" >
                    </div>
              ...
              <div id="sign_up_menu" class="tab-pane fade">
                  <form id = "sign_up_form" action = "enterNewUser.php" method = "POST" onsubmit = "return validateForm()">
					<div class = "form-group">
