...
<html>
<head>
	<title>ALTERNATE MEDICINES</title>
...
<nav class="navbar navbar-expand-sm" id="navbar1">
	<div class="container">
		...
		<!-- greeting -->
		<div id="greetings" class="text-muted ml-2 pl-1">Hi, Sanyam Jain!</div>
	</div>
</nav>
...
<div class="main_content">
	...
	<div class="d-flex flex-row mx-4 my-2 page_links">
		...
		<a href="alternate_medicines.php"><div>Alternate Medicines</div></a>
	...
	<div class="container-fluid">
		...
		<div class="d-flex flex-row flex-wrap justify-content-between"  >
			<?php
				...
				$select="SELECT * FROM medicineinfo WHERE Category='alternatemedicines'";
